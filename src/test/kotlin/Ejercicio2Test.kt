...
internal class Ejercicio2Test {
    ...
    fun `crear coche con todos los elementos`(){
        val coche = Vehiculo.Builder().setTipo("coche").setPuertas(2).setCv(100).setMotor("diesel").setRuedas(4).build()
        val expected = Coche(2,100,"diesel",4)
        assertEquals(expected,coche)
    }
    @Test
    fun `crear moto con todos los elementos`(){
        val moto = Vehiculo.Builder().setTipo("moto").setMotor("diesel").setRuedas(4).setCv(100).build()
        val expectedMoto = Moto(100,"diesel",4)
        assertEquals(expectedMoto, moto)
    }
    @Test
    fun `crear bici con todos los elementos`(){
        val bicicleta = Vehiculo.Builder().setTipo("bicicleta").setRuedas(4).build()
        val expectedBici = Bicicleta(4)
        assertEquals(expectedBici,bicicleta)
    }
    @Test
    fun `crear coche con algun elemento null`(){
        val coche = Vehiculo.Builder().setTipo("coche").setMotor("diesel").setRuedas(null).setCv(100).setPuertas(4)
    ...
    fun `crear moto con algun elemento null`(){
        val moto = Vehiculo.Builder().setTipo("moto").setRuedas(4).setCv(100).setMotor(null)
    ...
    fun `crear bici con algun elemento null`(){
        val bicicleta = Vehiculo.Builder().setRuedas(null).setTipo("bicicleta")
